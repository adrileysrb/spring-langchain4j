...
| 12 | Revisão de parecer | `pldft/service` | composição de 4, 5, 7, 8, 11 | `POST /api/analises/{id}/melhorias` |
...
Os testes não dependem do LM Studio: cobrem a cadeia de guardrails (lógica pura) e a subida do
contexto Spring.
